...
invoice_item_7 = InvoiceItem.create!(invoice_id: invoice_7.id, item_id: item_7.id, quantity: 3, unit_price: 50, status: 'shipped')
invoice_item_8 = InvoiceItem.create!(invoice_id: invoice_7.id, item_id: item_8.id, quantity: 6, unit_price: 50, status: 'shipped')
invoice_item_9 = InvoiceItem.create!(invoice_id: invoice_7.id, item_id: item_9.id, quantity: 9, unit_price: 50, status: 'shipped')
invoice_item_10 = InvoiceItem.create!(invoice_id: invoice_7.id, item_id: item_10.id, quantity: 12, unit_price: 50, status: 'shipped')
